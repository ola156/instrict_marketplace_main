  ...
  try {
    ...
    if (updateError) {
      ...
      Sentry.captureException(updateError, {
        tags: { flow: 'rider-release-job', portal: 'rider', kind },
        extra: { id },
      });
    ...
    notifyRidersOfNewJob(supabase, {
      ...
      Sentry.captureException(err, {
        tags: { flow: 'rider-release-job', step: 'notify-riders' },
        extra: { kind, id },
      });
    });
    ...
    console.error('rider release job route error:', err);
    Sentry.captureException(err, {
      tags: { flow: 'rider-release-job', step: 'unhandled' },
    });
